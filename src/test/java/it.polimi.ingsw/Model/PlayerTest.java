...
public class PlayerTest {
    ...
    public void getPlayerColor(){
        Player player=new Player(TowerColor.BLACK,"Mario");
    ...
    public void OrderTest(){
        ...
        players[0]=new Player(TowerColor.BLACK,"Mario");
        players[1]=new Player(TowerColor.WHITE,"Sandro");
        players[2]=new Player(TowerColor.GREY,"Giulio");
